...
export interface MinimapHandle {
  update: (bounds: ViewportBounds) => void;
}
...
export const WorldMinimap = forwardRef<MinimapHandle, WorldMinimapProps>(
  ({ layout, maps }, ref) => {
...
WorldMinimap.displayName = "WorldMinimap";
