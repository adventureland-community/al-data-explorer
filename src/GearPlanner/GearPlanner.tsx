...
import { Entity, ItemInfo, StatType } from "typed-adventureland";
        ...
        <Card>
            <CardContent>
                <Typography component="div" sx={{ textAlign: "left", marginBottom: 5 }}>
                    ...
                    <br />
                    You can currently select items on each equipment slot, you can also export your
                    selection but it has no uses.
                </Typography>
                ...
                <ul style={{ textAlign: "left" }}>
                    ...
                    <li>
                        compare gain / loss with currently equipped item on item tooltip when
                        selecting new
                    </li>
                    <li>set items</li>
                    <li>titles</li>
...
export function GearSlot({
    ...
    let itemName: ItemKey = `shade_${slot.replace("1", "").replace("2", "")}` as ItemKey;
