...
import { createTheme, CssBaseline, Tab, Tabs, ThemeProvider, useMediaQuery } from "@mui/material";
// import { StatType } from "typed-adventureland";
...
function Menu() {
  const routeMatch = useRouteMatch(["/", "/market", "/gear", "/monsters", "/bank", "/hof"]);
  ...
  return (
    <Tabs value={currentTab} centered sx={{ marginBottom: "15px" }}>
      ...
      <Tab label="HOF" value="/hof" to="/hof" component={RouterLink} />
    </Tabs>
  );
}
